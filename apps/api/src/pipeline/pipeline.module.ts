...
@Module({
  ...
  imports: [CandidateEmailsModule, CandidateSmsModule, CandidateWhatsappModule, JobsModule, NotificationsModule, ApprovalsModule, FieldPermissionsModule, JobBoardsModule, HrisModule, DripModule, SurveysModule],
