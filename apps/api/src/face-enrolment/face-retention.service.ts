...
// Deletes face reference images (and clears the row) 90 days after the owning attempt finalised.
// Scheduled as a nightly BullMQ job scheduler by ScheduledSweepsModule.
@Injectable()
