...
ALTER TABLE [dbo].[audit_logs] ADD CONSTRAINT [audit_logs_created_at_df] DEFAULT GETUTCDATE() FOR [created_at], CONSTRAINT audit_logs_pkey PRIMARY KEY CLUSTERED ([id]);
...
ALTER TABLE [dbo].[organizations] ADD CONSTRAINT [organizations_created_at_df] DEFAULT GETUTCDATE() FOR [created_at], CONSTRAINT organizations_pkey PRIMARY KEY CLUSTERED ([id]);
...
ALTER TABLE [dbo].[plans] ADD CONSTRAINT [plans_created_at_df] DEFAULT GETUTCDATE() FOR [created_at], CONSTRAINT plans_pkey PRIMARY KEY CLUSTERED ([id]);
...
ALTER TABLE [dbo].[refresh_tokens] ADD CONSTRAINT [refresh_tokens_created_at_df] DEFAULT GETUTCDATE() FOR [created_at], CONSTRAINT refresh_tokens_pkey PRIMARY KEY CLUSTERED ([id]);
...
ALTER TABLE [dbo].[users] ADD CONSTRAINT [users_created_at_df] DEFAULT GETUTCDATE() FOR [created_at], CONSTRAINT users_pkey PRIMARY KEY CLUSTERED ([id]);
