    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          aria-label={label}
          className="text-sm text-gray-600 file:mr-2 file:rounded file:border file:border-rule file:bg-primary file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-on-primary hover:file:opacity-90"
          onChange={(e) => {
