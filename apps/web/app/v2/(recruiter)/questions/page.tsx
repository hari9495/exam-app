...
const TYPE_COLOR: Record<QuestionType, string> = { single_mcq: VIZ.azure, multi_mcq: VIZ.azure, true_false: VIZ.azure, code: VIZ.violet, essay: VIZ.violet, file_upload: VIZ.violet, spoken: VIZ.violet };
