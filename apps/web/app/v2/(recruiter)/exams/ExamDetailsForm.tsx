...
const ghostBtn: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', fontSize: 13, fontWeight: 500, padding: '9px 14px', borderRadius: 9, border: '1px solid color-mix(in srgb, var(--ink) 24%, var(--hair))', background: 'var(--paper)', color: 'var(--ink)', cursor: 'pointer', textDecoration: 'none', boxShadow: '0 1px 2px rgba(11,18,32,.08)' };
