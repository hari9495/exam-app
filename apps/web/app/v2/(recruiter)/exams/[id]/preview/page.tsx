...
const QUESTION_TYPE_LABEL: Record<Question['type'], string> = { single_mcq: 'Single choice', multi_mcq: 'Multiple choice', true_false: 'True / False', code: 'Code', essay: 'Essay / subjective', file_upload: 'File upload', spoken: 'Spoken' };
