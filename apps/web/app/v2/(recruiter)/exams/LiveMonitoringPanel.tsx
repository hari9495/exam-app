  ...
  return (
    <div>
      ...
      <Dialog open={bypassAttemptId !== null} onClose={() => { setBypassAttemptId(null); setBypassReason(''); }} title="Relax proctoring for this candidate">
        ...
        <textarea id="bypass-reason" value={bypassReason} onChange={(e) => setBypassReason(e.target.value)} rows={3} maxLength={500} style={{ width: '100%', boxSizing: 'border-box', marginBottom: 16, padding: '9px 11px', fontSize: 13, borderRadius: 8, border: '1px solid var(--hair)', background: 'var(--surface)', color: 'var(--ink)', outline: 'none', resize: 'vertical', fontFamily: 'inherit' }} />
